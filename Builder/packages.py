...
BASE = Packages(
	pacman=DistributionPackages(
		common=[
			'ark', 'automake', 
    		'bat', 'blueman', 'bluez', 'bluez-utils', 'brightnessctl', 'btop', 
			'clang', 'clipnotify', 'cmake', 'cowsay', 
			'downgrade', 'dpkg', 'dunst', 
			'evince', 
			'fakeroot', 'fastfetch', 'ffmpeg', 'ffmpegthumbnailer', 'firefox', 'fish', 'fisher', 
			'gcc', 'git', 'gnome-disk-utility', 'gnu-netcat', 'gparted', 'gvfs', 'gzip', 
			'imagemagick', 
			'jq', 
			'kitty', 
			'libnotify', 
			...
			'lsd', 
			'make', 'mat2', 'micro', 
			'nemo', 'neovim', 'netctl', 'networkmanager-openvpn', 
			'openssh', 'openvpn', 
			'p7zip', 'pacman-contrib', 'pamixer', 'papirus-icon-theme', 'parallel', 
            'pavucontrol', 'pipewire', 'pipewire-alsa', 'pipewire-audio', 'pipewire-jack', 
            'pipewire-pulse', 'playerctl', 'polkit-gnome', 'pyenv', 'python-pyalsa', 
            'qt5-graphicaleffects', 'qt5-quickcontrols2', 'qt5-svg', 'qt5ct', 'qt6ct', 
            'ranger', 'redshift', 'reflector', 'rofimoji', 
            'sddm', 'shellcheck', 'sshfs', 'starship', 'sudo', 
            'timeshift', 'tmux', 'tree', 'ttf-fira-code', 'ttf-hack-nerd', 
            'ttf-iosevka-nerd', 'ttf-jetbrains-mono', 'ttf-jetbrains-mono-nerd', 
            'udiskie', 'unrar', 'unzip', 'upower', 'usbutils', 'uthash', 
            'vlc', 
            'wget', 'wireplumber', 'wmname', 
